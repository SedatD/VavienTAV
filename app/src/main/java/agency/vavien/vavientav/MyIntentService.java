...
public class MyIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "agency.vavien.vavientav.action.FOO";
    private static final String ACTION_BAZ = "agency.vavien.vavientav.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "agency.vavien.vavientav.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "agency.vavien.vavientav.extra.PARAM2";

    public MyIntentService() {
        super("MyIntentService");
    }

    public MyIntentService(String awk) {
        super("MyIntentService");
    }
